...
public class OldKnightsTour {
    ...
    public OldKnightsTour(final int m, final int n) {
    ...
    public OldKnightsTour(final int n) {
        this(n, n);
    }
    ...
    public static void main(final String[] args) {
        final OldKnightsTour kt = new OldKnightsTour(5, 6);
        kt.findTour();
