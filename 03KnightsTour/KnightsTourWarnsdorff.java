...
public class KnightsTourWarnsdorff {
    ...
    public KnightsTourWarnsdorff(final int m, final int n) {
        this.m = m;
        this.n = n;
        mn = m * n;
        realM = m + 4;
    ...
    public KnightsTourWarnsdorff(final int n) {
        this(n, n);
    }
    ...
    public static void main(final String[] args) {
        ...
        final KnightsTourWarnsdorff kt = new KnightsTourWarnsdorff(83);
        kt.findTour();
